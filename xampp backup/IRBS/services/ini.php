...
Class DBConn{
	...
	var $database = "ihosting_r2g";//ihosting_r2g
	var $username = "root";
	var $password = "";
}
...
if (!defined('A_ROOT')) {
	define('A_ROOT', 'https://IRBS.com.my/');
}
...
if (!defined('HASH_PASSWORD_API')) {
	define('HASH_PASSWORD_API', 'https://ihosting360.com/r2g/users/hashed_password');
}
